...
export default function PrivacyPage() {
  return <LegalPage title="Privacy Policy">
    ...
    <h2>Processors</h2><p>Configured hosting, PostgreSQL, email, Redis, and Google Gemini providers process data to operate the service. When you use chat or study tools, your prompts and relevant extracted material are sent to the Gemini API. MindForge currently uses Gemini&apos;s free tier, where Google states submitted content may be used to improve its products. Speech playback is performed locally by your browser.</p>
