...
export default function SecurityPage() {
  return <LegalPage title="Security">
    <h2>Current safeguards</h2><ul><li>Account-scoped database queries for sessions, messages, exports, and materials.</li><li>Identity, email verification, and session management delegated to Clerk; MindForge stores no passwords.</li><li>Same-origin enforcement for browser mutations and distributed production rate limits.</li><li>Private source downloads, security headers, structured error reporting, and audit events.</li><li>Production readiness checks covering the database and required runtime configuration.</li></ul>
